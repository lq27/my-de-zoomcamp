...
---> Kestra flows: 
        /home/abbythecat27/my-de-zoomcamp/2_kestra/zoomcamp.gcp_taxi_ingest.yml
...
---> Kestra flows: 
        /home/abbythecat27/my-de-zoomcamp/2_kestra/zoomcamp.gcp_taxi_scheduled.yml
...
---> Kestra flows: 
        /home/abbythecat27/my-de-zoomcamp/2_kestra/zoomcamp.gcp_bq_delete_table.yml
        /home/abbythecat27/my-de-zoomcamp/2_kestra/zoomcamp.gcp_taxi_ingest.yml  
...
To copy files from kestra to GCP VM, first export them to local. Then to copy from local:
$ scp -i ~/.ssh/gcp C:/Users/myname/Downloads/flows/* user@vm_ip:~/my-de-zoomcamp/2_kestra
